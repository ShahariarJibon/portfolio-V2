    ...
    <div className="min-h-screen bg-black">
      <div className="max-w-6xl mx-auto px-6 py-10">
        <div className="flex items-center justify-between mb-12">
          <div>
            <h1 className="text-2xl font-[family-name:var(--font-heading)] text-white">Messages</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/admin/achievements" className="flex items-center gap-2 px-5 py-2.5 rounded-xl border border-white/10 text-[#888888] text-xs tracking-[0.15em] uppercase hover:border-white/30 hover:text-white transition-all">
              <Award size={14} /> Achievements
            </Link>
            <Link href="/admin/activity" className="flex items-center gap-2 px-5 py-2.5 rounded-xl border border-white/10 text-[#888888] text-xs tracking-[0.15em] uppercase hover:border-white/30 hover:text-white transition-all">
