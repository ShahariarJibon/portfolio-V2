    ...
    <div className="min-h-screen bg-black pt-28 pb-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold font-[family-name:var(--font-heading)] mt-2 text-white">
            All <span className="text-[#888888]">Work</span>
          </h1>
        </motion.div>
        ...
        {loading ? (
          ...
          <div className="text-center py-24">
            <p className="text-[#555555] text-sm">No projects yet</p>
          </div>
        ) : (
          <div className="grid md:grid-cols-2 gap-6">
